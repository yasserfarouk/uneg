...
# Repository: projects/uneg
echo -e "${BLUE}Restoring: projects/uneg${NC}"
if [ -d "projects/uneg/.git" ]; then
    ...
    if git clone "git@github.com:yasserfarouk/uneg.git" "projects/uneg"; then
